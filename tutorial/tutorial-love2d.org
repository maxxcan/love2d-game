...
Dentro de este fichero, vamos a crear una variable. Pondremos *--! file:* arribad de todos los bloques de código para hacer más calro que en ese archivo hemos puesto el código.
...
Como las funciones, los archivos pueden devolver un valor. Si queremos devovler 10 al final del archivo ejemplo.lua, y dentro del archivo main.lua escribimos *pirnt(require("ejemplo"))* , entonces veremos que devuelve 10. 
